...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=monaco&box=7.507310,43.793283,7.357973,43.685485
...
-----------
  ...
  * monaco Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * monaco Height Map (SRTM3 v4.1).png
  ...
  * monaco Height Map (SRTM30 Plus).png
